...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Add New Sale Product Data</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ action('SaleController@store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-2">
                                    ...
                                    <input id="initialprice" data-type="currency" type="text" class="form-control{{ $errors->has('initialprice') ? ' is-invalid' : '' }}" name="initialprice"  placeholder="Initial Price" required>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-2">
                                    ...
                                    <input id="price" data-type="currency" type="text" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price"  placeholder="Sale Price" required>
                                </div>
                                @if ($errors->has('price'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <input type="number" name="save" min="1" max="100" class="form-control" placeholder="%">
                            </div>
                        </div>
