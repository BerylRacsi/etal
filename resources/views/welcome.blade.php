            ...
            <div class="row">
                <div class="col-md-6 p-b-30 m-lr-auto">
                    ...
                    <div class="block1 hov-img0 wrap-pic-w">
                        <img src="{{asset($men->cover)}}" alt="IMG-BANNER">
                ...
                <div class="col-md-6 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 hov-img0 wrap-pic-w">
                        <img src="{{asset($women->cover)}}" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
                    ...
                    <div class="block1 wrap-pic-w">
                        <img src="{{asset($top->cover)}}" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="{{asset($bottom->cover)}}" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="{{asset($accessories->cover)}}" alt="IMG-BANNER">
