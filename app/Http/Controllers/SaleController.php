...
class SaleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin/sale/index', compact('products','stocks'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $latestOrder = Sale::orderBy('created_at','DESC')->first();
        ...
        $initialpricefixed = str_replace(',', '',$request->input('initialprice'));
        $products->initialprice = $initialpricefixed;
        $products->save = $request->input('save');
    ...
    public function show($id)
    {
        ...
        return view('admin.sale.show',compact('products','stocks'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.sale.edit',compact('products','stocks'));
    }
    ...
    public function destroy($id)
    {
        ...
        $stock->delete();
        $product->delete();
        return redirect('admin/sale')->with('status', 'Product Removed!');
    }
}
